...
FirebaseBusDatabaseRemoteDataSource injectFirebaseBusDatabaseRemoteDataSourceImpl(){
  return FirebaseBusDatabaseRemoteDataSourceImpl(database: injectFirebaseBusDatabase());
}

class FirebaseBusDatabaseRemoteDataSourceImpl implements FirebaseBusDatabaseRemoteDataSource{
